	...
	try{
		...
		//out.println("Total Row :" +count);
			while(i<=resultSet1.getRow()){
				...
				st1.executeUpdate("insert into marks(rollNo, advJava, PHP, CN, TE, Lab) values('"+rollNo+"',"+Advjava+","+PHP+","+CN+","+TE+", "+Lab+")");
				i++;
			}
		}
		Statement st2 = con.createStatement();
		st2.executeUpdate("UPDATE lock_request SET faculty_lock=1");
